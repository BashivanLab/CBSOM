...
class SOCONV (nn.Module):
  def __init__ (self,in_channels, num_kernels,Kernel_size,stride,alpha,sigma,decay_rate,padding):
  ...
  def BMU(self):
      ...
      bmu_indexes = torch.linalg.norm(self.conv1.post_activations,dim=(1,2)).argmax()
